...
enum tsi148sstModes {
	TSI148_SST160 = 0, TSI148_SST267, TSI148_SST320
};
...
int vme_waitInterrupt(INT32 deviceHandle, UINT32 selectedInts, UINT32 timeout,
		UINT32 *intNum);
...
int vme_readVerrInfo(INT32 deviceHandle, UINT32 *Address, UINT8 *Direction,
		UINT8 *AmCode);
#ifdef LINUXOS
