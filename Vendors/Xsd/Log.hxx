...
{
  /**
   * @brief Class corresponding to the %LogType schema type.
   *
   * @nosubgrouping
   */
  class LogType: public ::xml_schema::type
  {
    public:
    /**
     * @name Text
     ...
     * @brief Element type.
     */
    typedef ::cs::LogLevel LogLevel_type;
  ...
  /**
   * @brief Class corresponding to the %LogList schema type.
   *
   * @nosubgrouping
   */
  class LogList: public ::xml_schema::type
  {
    public:
    /**
     * @name LOG
     *
     * @brief Accessor and modifier functions for the %LOG
     * required element.
     */
    //@{
  ...
  /**
   * @brief Enumeration class corresponding to the %LogLevel
   * schema type.
   */
  class LogLevel: public ::xml_schema::string
  {
    public:
    ...
    public:
    static const char* const _xsd_LogLevel_literals_[4];
    static const value _xsd_LogLevel_indexes_[4];
...
{
  /**
   * @name Parsing functions for the %LogList document root.
   */
  //@{
   ...
   */
  ::std::auto_ptr< ::cs::LogList >
  LogList_ (::xercesc::InputSource& is,
            ::xml_schema::flags f = 0,
            const ::xml_schema::properties& p = ::xml_schema::properties ());
...
{
  /**
   * @name Serialization functions for the %LogList document root.
   */
  //@{
   ...
   */
  void
  LogList_ (::xercesc::XMLFormatTarget& ft,
            const ::cs::LogList& x, 
            const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
            const ::std::string& e = "UTF-8",
            ::xml_schema::flags f = 0);
  ...
  void
  operator<< (::xercesc::DOMElement&, const LogType&);

  void
  operator<< (::xercesc::DOMElement&, const LogList&);

  void
  operator<< (::xercesc::DOMElement&, const LogLevel&);

  void
  operator<< (::xercesc::DOMAttr&, const LogLevel&);
